...
pub const analyzer_name = 'velvet'
...
pub const analyzer_caches_path = os.join_path(os.cache_dir(), 'velvet', '${metadata.build_commit}_${os.file_last_mod_unix(os.executable())}')
