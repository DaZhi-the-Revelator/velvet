...
const download_dir = os.join_path(os.vtmp_dir(), 'velvet')
const analyzer_install_script_download_path = 'https://raw.githubusercontent.com/DaZhi-the-Revelator/velvet/main/install.vsh'
